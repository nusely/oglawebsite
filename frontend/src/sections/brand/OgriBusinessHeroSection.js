  ...
  return (
    <section className="relative h-screen overflow-hidden">
        ...
        <div className="container">
          ...
          >
            ...
            <div className="flex justify-start mb-6">
              <Link 
                to="/"
                className="inline-flex items-center text-white hover:text-green-300 transition-colors backdrop-blur-sm bg-white/10 px-3 py-2 rounded-full text-sm"
              >
            ...
            <Link 
              to="/products" 
              className="inline-flex items-center bg-[#2E7D32] text-white px-10 py-4 rounded-full hover:bg-[#4CAF50] transition-all duration-300 font-bold text-xl shadow-2xl hover:shadow-3xl transform hover:scale-105"
            >
              View Products
      ...
      {showTestimonials && testimonials.length > 0 && (
        <TestimonialsOverlay testimonials={testimonials} brandSlug="ogribusiness" />
      )}
    </section>
  );
};

export default OgriBusinessHeroSection;
