...
const RequestForm = () => {
  ...
  const { items: requestItems, totalAmount, clearRequestBasket: clearRequest } = useRequestBasket();
  const { user } = useAuth();
  ...
  const validateForm = () => {
    ...
    if (formData.companyAddress.street && !formData.companyAddress.city) {
      newErrors.companyAddressCity = 'City is required if street address is provided';
    }
  ...
  const submitRequest = async (submissionData) => {
    ...
    try {
      ...
      if (error.message.includes('Failed to fetch letterhead')) {
        ...
        errorMessage = 'No items found in request. Please add items to your request basket.';
      } else if (error.message.includes('missing required fields')) {
        errorMessage = 'Some items are missing required information. Please check your request basket.';
      }
      ...
      <div className="container">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-4">Submit Your Request</h1>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-blue-800 mb-3">
                  Upon submission, a Proforma Invoice will be automatically generated with:
                </p>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                          ...
                          <input
                            ...
                            onChange={handleInputChange}
                            className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-golden-500 focus:border-golden-500 ${
                              errors.companyAddressCity ? 'border-red-300' : 'border-gray-300'
                            }`}
                            placeholder="Enter city"
                          />
                          {errors.companyAddressCity && (
                            <p className="mt-1 text-sm text-red-600">{errors.companyAddressCity}</p>
                          )}
                        </div>
                        <div>
                          <label className="block text-sm font-medium text-gray-700 mb-2">
                  ...
                  <div className="flex justify-end space-x-4 pt-6">
                    ...
                    <button
                      ...
                      className="px-8 py-3 bg-golden-600 text-white rounded-lg hover:bg-golden-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center"
                    >
                      {isSubmitting ? (
                        <>
          ...
          >
            ...
            <div className="space-y-4 mb-6">
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                <h4 className="font-semibold text-blue-900 mb-2">Benefits of having an account:</h4>
